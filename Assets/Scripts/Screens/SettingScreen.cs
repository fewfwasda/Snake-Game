...
public class SettingScreen : MonoBehaviour
{
    ...
    {
        LeanTween.scale(setting, Vector3.zero, .4f).setOnComplete(StartPositionSetting);
    }
    private void StartPositionSetting()
    {
        setting.transform.position = new Vector3(0, 7.5f, 0);
        setting.transform.localScale = new Vector3(2, 2, 2);
    }
}
